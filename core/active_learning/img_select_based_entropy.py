...
if __name__ == '__main__':
    ...
    cs_txt = "/data1/glc/ILM-ASSL-master/data/cs/cs_all_list.txt"
    first_labeled_txt = "/data1/glc/ILM-ASSL-masterr/data/gtav2cityscapes/2.2%/labeled_cs30.txt"  # 30
    second_labeled_txt = "/data1/glc/ILM-ASSL-master/data/gtav2cityscapes/2.2%/labeled_cs35.txt"
    city_uncertainty_dir = "/data1/glc/ILM-ASSL-master/experiments/gtav2cityscapes/1.0%/checkpoints/act_learn_out/city_uncertainty/"
